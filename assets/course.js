/* AI-ML Learn — shared course renderer for Parts 6-9.
 *
 ...
 *
 * Parts 1-5 keep their own monolithic assets/course.js + course-data.js and are untouched.
 */
(function () {
  'use strict';
  ...
  var KEY = 'aml-learn-progress-' + PART.num;           /* namespaced so P6..P9 don't collide with P1..P5 */
  ...
  function footer(extraFirst) {
    return '<footer class="c-foot"><div class="links">' +
      ...
      partNavLinks('') +
      '<a href="../lab/playground.html">🔬 Playground</a>' +
      ...
      '<div>Standard tools, operated — not reimplemented · © ' + new Date().getFullYear() + ' · AI-ML by Satyabhan</div></footer>';
  }
  function pathStrip() {
  ...
  function renderHub() {
    ...
    app.innerHTML =
      ...
      (PART.standardNote ? '<p class="foot-note">📐 <b>Standard, not from-scratch.</b> ' + PART.standardNote + '</p>' : '') +
